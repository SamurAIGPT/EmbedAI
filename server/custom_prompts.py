...
swiss_finish_doc_prompt = PromptTemplate(template=pascal_template, input_variables=["context", "question"])

chat_template = """Assistant is a large language model trained by OpenAI.
